...
public class Courses extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(hour, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int hr =  Integer.parseInt(hour.getText());
           ...
           JOptionPane.showMessageDialog(null, "Done "," Course ", JOptionPane.INFORMATION_MESSAGE);
        course c = new course(Id, name , hr); // constructer
         
           try {
            File f1 = new File("courseT.txt");
          ...
          //course cc = c;
            ...
            pr.println(c.printInfo(c));
           
               /*pr.println("Course id: " + c.getCourseId() + "\n"
                        + "Course name: " + c.getCourseName() + "\n"
                        + "Course hour: " + c.getCourseHoure() + "\n"
                        + "----------------------");
               */
		  ...
		  System.exit(1);
	  } catch (IOException inputOut) {
            Logger.getLogger(Courses.class.getName()).log(Level.SEVERE, null, inputOut);
        }
